...
produtos.forEach(produto => {
  ...
  artigo.innerHTML = `
    ...
    <p><strong>Custo total:</strong> ${produto.price} €</p>
    <p style="background-color: lightgray; border-radius:10px;">${produto.description.substring(0, 150)}...</p>
  ...
  botao.addEventListener('click', () => {
    ...
    item.textContent = `${produto.title} - ${produto.price} €`;
